...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Portfolio.portfolio_item'
        db.add_column(u'theme_portfolio', 'portfolio_item',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['theme.PortfolioItem'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PortfolioItem.portfolio'
        db.delete_column(u'theme_portfolioitem', 'portfolio_id')


    def backwards(self, orm):
        # Deleting field 'Portfolio.portfolio_item'
        db.delete_column(u'theme_portfolio', 'portfolio_item_id')

        # Adding field 'PortfolioItem.portfolio'
        db.add_column(u'theme_portfolioitem', 'portfolio',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='portfolio', null=True, to=orm['theme.Portfolio'], blank=True),
                      keep_default=False)
