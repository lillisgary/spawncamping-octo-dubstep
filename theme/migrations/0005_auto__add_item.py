...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Item'
        db.create_table(u'theme_item', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('_order', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('portfolio', self.gf('django.db.models.fields.related.ForeignKey')(related_name='items', to=orm['theme.Portfolio'])),
        ...
        db.send_create_signal(u'theme', ['Item'])


    def backwards(self, orm):
        # Deleting model 'Item'
        db.delete_table(u'theme_item')
    ...
    models = {
        ...
        u'theme.item': {
            'Meta': {'ordering': "(u'_order',)", 'object_name': 'Item'},
            '_order': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            ...
            'portfolio': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'items'", 'to': u"orm['theme.Portfolio']"})
        },
        u'theme.portfolio': {
