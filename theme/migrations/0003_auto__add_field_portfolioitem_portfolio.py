...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'theme_portfolioitem', 'portfolio',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='portfolio', null=True, to=orm['theme.Portfolio']),
                      keep_default=False)
    ...
    models = {
        ...
        u'theme.portfolioitem': {
            ...
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['pages.Page']", 'unique': 'True', 'primary_key': 'True'}),
            'portfolio': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'portfolio'", 'null': 'True', 'to': u"orm['theme.Portfolio']"}),
